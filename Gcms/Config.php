...
class Config extends \Kotchasan\Config
{
    ...
    /**
     * ปีงบประมาณ
     * Y-01-01 = วันที่ 1 มกราคมของทุกปี (เอกชน)
     * Y-10-01 = วันที่ 1 ตุลาคมของทุกปี (รายการ)
     *
     * @var string
     */
    public $eleave_fiscal_year = 'Y-01-01';
    /**
     * ชนิดของไฟล์ที่สามารถอัปโหลดได้
     *
     * @var array()
     */
    public $eleave_file_typies = array('jpg', 'jpeg', 'pdf');
}
